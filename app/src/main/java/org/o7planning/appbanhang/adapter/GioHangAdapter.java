...
import org.o7planning.appbanhang.Interface.IImageClickListerner;
...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.setListerner(new IImageClickListerner() {
            @Override
            public void onImageClick(View view, int pos, int giatri) {
                if (giatri == 1){
                    ...
                    if (gioHangList.get(pos).getSoluong() < 99){
                        int soluongmoi = gioHangList.get(pos).getSoluong()+1;
                        gioHangList.get(pos).setSoluong(soluongmoi);
                    }
    ...
    public class MyViewHolder  extends  RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        IImageClickListerner listerner;
        ...
        public void setListerner(IImageClickListerner listerner) {
